...
abstract class CurrencyRemoteDataSource {
  // register
  Future<List<Crypto>> getData({required String start,required String limit});
...
class CurrencyRemoteDataSourceImpl implements CurrencyRemoteDataSource{
  ...
  CurrencyRemoteDataSourceImpl({required this.networkCall});
  List<Crypto> cryptoList = [
  ];

  @override
  Future<List<Crypto>> getData({required String start,required String limit}) async{
    try{
      String endPoint =  loginEndpoint;
      print("CurrencyRemoteDataSourceImpl->getData");
      ...
      print("CurrencyRemoteDataSourceImpl->getData response");
      print(dataResponse);
      ...
      try{
        // Crypto crypto = Crypto.fromJson(dataResponse["data"]);
        var jsondecode = json.decode(dataResponse.body);
        ...
        print('CurrencyRemoteDataSourceImpl->getData   serialization exception $innerExp');
        print(stackTrace);
        rethrow;
      }
