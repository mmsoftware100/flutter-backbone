...
ကျေးဇူးပြုပြီး  နာမည်၊ အီးမေးလ် နှင့် စကားဝှက်များကို ပြန်လည်စီစစ်ပြီး ပြောင်းလဲဖြည့်သွင်းပါ
             ...
             return response("Email ရိုက်ထည့်ပေးပါ",404)->header('Content-Type', 'text/plain');
return response("ကျေးဇူးပြုပြီး  နာမည်၊ အီးမေးလ် နှင့် စကားဝှက်များကို ပြန်လည်စီစစ်ပြီး ပြောင်းလဲဖြည့်သွင်းပါ", 404)->header('Content-Type', 'text/plain');
...
8) [x] Password ကို Shared Preference မှာ သိမ်းမယ်။ Automatic Login လုပ်
