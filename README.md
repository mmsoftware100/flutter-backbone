...
Ko Naung
1) app ကို စဖွင့်ဖွင့်ချင်း login မရောက်ခင် loading မှာ ပေါ်တဲ့ fumo image ကို ကြည့်ကောင်းအောင်လေး၊ အခုက လေးထောင့်ကွက်ကြီး ဖြစ်နေလို့ပါ၊ -> Splash Screen Background color -> White
2) setting bar ကို နည်းနည်း ကကြွကြွ လန်းတာလေး၊ background/ color/liner/designကိုမှ လန်းတာလေးပေါ့၊  language changer ကိုလည်း တညီထဲလေး ဖြစ်ဖြစ် လုပ်ပေးပါ၊
...
5) Earn မှာ ဆိုလည်း စာလုံးကြည့်ရတာ နည်းနည်း ကြွနေအောင်လေးပေါ့၊ Level-1 လိုဟာတွေဆို ခေါင်းစဉ်သေးမှန်း အောင်ဆုံးစာပိုဒ်ဆို justify လေး ဖြစ်ဖြစ်၊ အောက်နဲ့အရမ်းလည်း ကပ်သလိုပဲ
   6)Calculator မှာ အေါ်အောက်ဆွဲရင် နောက်ခံ background အပြာခြမ်းက ထင်တယ် ကြီးလိုက်သေးလိုက်ဖြစ်နေလို့ မှိတ်တုတ်မှိတ်တုတ်ဖြစ်
6) Wallet မှာလည်း withdraw address လေးလိုဟာဖြစ်ဖြစ် ဒီဇိုင်း ကြွနေရင် ပိုကောင်း အောက်နဲ့ကပ်၊
7) 
## 2023-07-21 
- [x] Webview Progress
- [x] Webview URL
